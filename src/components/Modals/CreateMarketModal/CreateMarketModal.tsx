...
const CreateMarketModal = ({ isOpen }: ICreateMarketModalProps) => {
  ...
  const [marketOpeningTime, setMarketOpeningTime] = useState<number>(1590480640);
  const [marketLockingTime, setMarketLockingTime] = useState<number>(1590480640);
  const [marketResolutionTime, setMarketResolutionTime] = useState<any>(1590480640);
